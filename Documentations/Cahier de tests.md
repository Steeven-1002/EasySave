...
| CFG-FR-005 | Choix de l'extension du fichier log : XML ou json | Cliquer sur le bouton "Extension log XML" ou "Extension log json" pour passer d'une option à l'autre. |
