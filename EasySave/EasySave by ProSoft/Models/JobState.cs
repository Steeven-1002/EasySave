...
namespace EasySave_by_ProSoft.Models {
	...
	public class JobState {
		...
		/// <summary>
		/// Constructor that initializes the state file path
		/// </summary>
		/// <param name="stateFilePath">Path to the state.json file</param>
		public JobState(string stateFilePath) {
		...
		private string ConvertStateToString(BackupState state)
		{
			return state switch
			{
				...
				_ => "WAITING" // Default to WAITING instead of UNKNOWN
			};
		}
		...
		/// <summary>
		/// Creates a snapshot of this JobState for state.json
		/// </summary>
		/// <returns>A deep copy of this JobState</returns>
